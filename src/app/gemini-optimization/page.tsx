...
export const metadata: Metadata = {
  title: "Google Gemini AI Optimization Services in Goa | Sanctify",
  description: "Sanctify optimizes your business for Google Gemini AI Overviews — appear in AI-generated summaries above traditional Google results. First Goa agency offering this.",
    ...
    <>
          ...
          <div className="max-w-3xl">
            <nav aria-label="Breadcrumb" className="mb-6">
              <ol className="flex items-center gap-2 text-white/50 text-sm">
                ...
                <li className="text-white/80">Gemini Optimization</li>
              </ol>
            </nav>
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-white leading-tight">
              Google Gemini AI Optimization Services<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-secondary-light to-secondary">by Sanctify, Goa</span>
            </h1>
            <p className="mt-6 text-white/65 text-lg md:text-xl leading-relaxed max-w-2xl">Google Gemini AI Overviews now appear ABOVE traditional search results for millions of queries. Sanctify's Gemini Optimization ensures your Goa business is featured in these AI summaries — the most visible real estate in Google Search.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-6 hover-lift transition-all">
              ...
              <p className="text-gray text-sm leading-relaxed">Sanctify is Goa&apos;s FIRST agency offering dedicated Gemini Optimization services. Early adopters are already seeing results — don&apos;t let competitors get ahead.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-light">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 prose">
          ...
          <h2>How Gemini Optimization Differs from Traditional SEO</h2>
          <ul>
            <li><strong>Traditional SEO</strong> — Ranks your pages in Google&apos;s blue links. Users click through to your website.</li>
            <li><strong>Gemini Optimization</strong> — Gets your brand MENTIONED in AI-generated responses. Users see your brand name alongside the answer, building trust and recognition.</li>
          </ul>
          ...
          <h2>Industries Sanctify Serves with Gemini Optimization in Goa</h2>
          <ul>
          ...
          <h2>Sanctify&apos;s Gemini Optimization Results</h2>
          <ul>
          ...
          <h2>Get Started with Sanctify&apos;s Gemini Optimization</h2>
