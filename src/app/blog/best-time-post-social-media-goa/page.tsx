...
export const metadata: Metadata = {
  ...
  description: "Learn about best time post social media Goa. Expert insights from Sanctify — Goa's leading digital marketing agency with 12+ years of experience.",
