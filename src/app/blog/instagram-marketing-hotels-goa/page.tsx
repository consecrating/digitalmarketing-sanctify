...
export const metadata: Metadata = {
  ...
  description: "Learn about Instagram marketing hotels Goa. Expert insights from Sanctify — Goa's leading digital marketing agency with 14+ years of experience.",
