...
export const metadata: Metadata = {
  ...
  description: "Learn about digital marketing vs traditional Goa. Expert insights from Sanctify — Goa's leading digital marketing agency with 14+ years of experience.",
