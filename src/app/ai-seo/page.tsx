...
export const metadata: Metadata = {
  title: "AI SEO Services — Future-Proof Your Rankings in Goa | Sanctify",
  description: "Sanctify combines traditional SEO with AI optimization — rank on Google AND get cited by ChatGPT, Gemini & Perplexity. Goa's only unified AI+SEO agency.",
    ...
    <>
          ...
          <div className="max-w-3xl">
            <nav aria-label="Breadcrumb" className="mb-6">
              <ol className="flex items-center gap-2 text-white/50 text-sm">
                ...
                <li className="text-white/80">AI SEO</li>
              </ol>
            </nav>
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-white leading-tight">
              AI SEO Services — Future-Proof Your Rankings<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-secondary-light to-secondary">by Sanctify, Goa</span>
            </h1>
            <p className="mt-6 text-white/65 text-lg md:text-xl leading-relaxed max-w-2xl">Sanctify's AI SEO service is the unified approach: rank on Google's traditional results AND get cited by AI platforms simultaneously. One strategy, two search ecosystems — maximizing your Goa business's total digital visibility.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-6 hover-lift transition-all">
              ...
              <p className="text-gray text-sm leading-relaxed">Sanctify is Goa&apos;s FIRST agency offering dedicated AI SEO services. Early adopters are already seeing results — don&apos;t let competitors get ahead.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-light">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 prose">
          ...
          <p>AI SEO is the convergence of traditional Search Engine Optimization with AI platform optimization (GEO, AEO, LLMO). Rather than treating Google SEO and AI visibility as separate efforts, AI SEO creates a unified content and authority strategy that performs in both ecosystems. This is the future of search marketing — and Sanctify delivers it today.</p>

          <h2>Why Sanctify for AI SEO in Goa?</h2>
          <p>Sanctify is uniquely positioned for AI SEO because we've been doing traditional SEO in Goa since 2012 AND were among the first to adopt AI optimization in 2024. This dual expertise means we don't sacrifice Google rankings for AI visibility or vice versa. Our integrated methodology builds compounding authority that works across ALL search platforms.</p>

          <h2>Sanctify&apos;s AI SEO Process</h2>
          <ul>
          ...
          <h2>How AI SEO Differs from Traditional SEO</h2>
          <ul>
            <li><strong>Traditional SEO</strong> — Ranks your pages in Google&apos;s blue links. Users click through to your website.</li>
            <li><strong>AI SEO</strong> — Gets your brand MENTIONED in AI-generated responses. Users see your brand name alongside the answer, building trust and recognition.</li>
          </ul>
          ...
          <h2>Industries Sanctify Serves with AI SEO in Goa</h2>
          <ul>
          ...
          <h2>Sanctify&apos;s AI SEO Results</h2>
          <ul>
          ...
          <h2>Get Started with Sanctify&apos;s AI SEO</h2>
