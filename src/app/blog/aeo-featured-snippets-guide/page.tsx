...
export const metadata: Metadata = {
  ...
  description: "Expert guide on AEO featured snippets guide from Sanctify — Goa's first AI-ready digital marketing agency. 14+ years of SEO expertise combined with cutting-edge AI optimization.",
