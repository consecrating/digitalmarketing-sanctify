...
export const metadata: Metadata = {
  ...
  description: "Expert guide on AI search Goa tourism from Sanctify — Goa's first AI-ready digital marketing agency. 12+ years of SEO expertise combined with cutting-edge AI optimization.",
