...
export const metadata: Metadata = {
  ...
  description: "Expert guide on Perplexity AI citations guide from Sanctify — Goa's first AI-ready digital marketing agency. 12+ years of SEO expertise combined with cutting-edge AI optimization.",
