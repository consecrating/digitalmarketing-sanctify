...
export const metadata: Metadata = {
  ...
  description: "Learn about Google Ads vs Facebook Ads Goa. Expert insights from Sanctify — Goa's leading digital marketing agency with 14+ years of experience.",
